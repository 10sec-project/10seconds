...
{
    switch (unit) {
    case Unit::BTC: return QString("10Secondss");
    case Unit::mBTC: return QString("Milli-Second (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Second (secs) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
