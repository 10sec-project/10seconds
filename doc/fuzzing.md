# Fuzzing 10Seconds Core using libFuzzer
...
Every single pull request submitted against the 10Seconds Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitcoin Core more robust.
...
with certain assembly code from 10Seconds Core's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
To quickly get started fuzzing 10Seconds Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
To quickly get started fuzzing 10Seconds Core using [Honggfuzz](https://github.com/google/honggfuzz):
