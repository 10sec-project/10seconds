# Support for Output Descriptors in 10Seconds Core

Since 10Seconds Core v24.2.0, there is support for Output Descriptors. This is a
...
existing 10Seconds Core wallets, a convenience function `combo` is
