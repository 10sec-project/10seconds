# Support for Output Descriptors in Biteducoin Core

Since Biteducoin Core v24.2.0, there is support for Output Descriptors. This is a
...
existing Biteducoin Core wallets, a convenience function `combo` is
