...
"""Verify that starting 10seconds with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start 10seconds with -h for help text")
        ...
        self.log.info("Start 10seconds with -version for version information")
        ...
        self.log.info("Start 10secondsd with -fakearg to make sure it does not start")
