...
"""Verify that starting biteducoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start biteducoin with -h for help text")
        ...
        self.log.info("Start biteducoin with -version for version information")
        ...
        self.log.info("Start biteducoind with -fakearg to make sure it does not start")
