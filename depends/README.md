...
**Biteducoin Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to biteducoin's configure. In this case, `--disable-wallet`.
