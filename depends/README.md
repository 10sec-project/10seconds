...
**10Seconds Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to 10seconds's configure. In this case, `--disable-wallet`.
